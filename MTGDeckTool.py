...
price_label = Label(root, justify = "left", anchor = "w", bg = '#19232D', fg = 'white')
...
def viewed():
    ...
    price_label.configure(text = est)
...
def saved():
    ...
    error_label.configure(text = dln + ".txt was saved to the current folder", fg = "green")
